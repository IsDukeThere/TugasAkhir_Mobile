...
class _DetailState extends State<Detail> {
  ...
  String convertedTime = "";
   ...
   void _changeCurrency(String currency) {
    setState(() {
      ...
      hargaTiket = uangController.convert(50000, currency);
    });
  }
  ...
  Future<void> _openUserBox() async {
    String safeUsername = widget.username.isNotEmpty ? widget.username : "default";
  ...
  void _toggleWatchlist() async {
    if (watchlistBox == null || !watchlistBox!.isOpen) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Database sedang memuat, coba sesaat lagi...")),
      );
      _openUserBox(); 
      return;
    }
                            ...
                            Container(
                              ...
                              child: IconButton(
                                ...
                                icon: Icon(
                                  ...
                                  color: isSaved ? Color.fromARGB(255, 37, 216, 101) : Colors.white,
                                ),
                              ),
                            ),
                          ],
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          padding: const EdgeInsets.all(10),
                                          decoration: BoxDecoration(
                                            color: Color.fromARGB(255, 37, 216, 101).withOpacity(0.2),
                                            borderRadius: BorderRadius.circular(10),
                                          ),
                                          child: const FaIcon(FontAwesomeIcons.film, color: Color.fromARGB(255, 37, 216, 101), size: 24),
                                        ),
